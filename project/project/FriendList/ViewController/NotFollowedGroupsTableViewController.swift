...
class NotFollowedGroupsTableViewController: UITableViewController {
    ...
    static var notFollowedGroupsList: [GroupsListCellModel] = [.init(name: "BTS fans", iconName: "bts")]
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return NotFollowedGroupsTableViewController.notFollowedGroupsList.count
    }
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        let myAdd = UIContextualAction(style: .destructive, title: nil) { (_, _, compilationHand) in
            ...
            NotFollowedGroupsTableViewController.notFollowedGroupsList.remove(at: indexPath.row)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setData(with: NotFollowedGroupsTableViewController.notFollowedGroupsList[indexPath.row])
